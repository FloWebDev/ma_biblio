 ...
 */
final class Version20200418142146 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, reference, name, order_z, css FROM category');
        $this->addSql('DROP TABLE category');
        $this->addSql('CREATE TABLE category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, reference VARCHAR(32) NOT NULL COLLATE BINARY, name VARCHAR(64) NOT NULL COLLATE BINARY, order_z SMALLINT DEFAULT NULL, css VARCHAR(32) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO category (id, reference, name, order_z, css) SELECT id, reference, name, order_z, css FROM __temp__category');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, reference, name, css, order_z FROM category');
        $this->addSql('DROP TABLE category');
        $this->addSql('CREATE TABLE category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, reference VARCHAR(32) NOT NULL, name VARCHAR(64) NOT NULL, css VARCHAR(32) DEFAULT NULL, order_z SMALLINT DEFAULT NULL)');
        $this->addSql('INSERT INTO category (id, reference, name, css, order_z) SELECT id, reference, name, css, order_z FROM __temp__category');
        $this->addSql('DROP TABLE __temp__category');
    }
}
