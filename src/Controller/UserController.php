...
class UserController extends AbstractController
{
    ...
    public function askNewPassword(Request $request, UserRepository $userRepository, ForgotPassword $forgotPwd, MailerInterface $mailer)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            ->text('Bonjour ' . ucfirst($user->getUsername()) . ', Suite à votre demande de réinitialisation de mot de passe, merci de vous rendre sur le lien suivant pour en enregistrer un nouveau sécurisé :' . $forgot_password_url . 'Le lien est valide 15 minutes. Merci de ne pas répondre à ce message. Si besoin, utilisez le formulaire de contact présent sur la page d\'accueil du site. Bien à vous. ' . $this->getParameter('website_title'))
            ->html('<p> Bonjour ' . ucfirst($user->getUsername()) . ',<br><br>Suite à votre demande de réinitialisation de mot de passe, merci de vous rendre sur le lien suivant pour en enregistrer un nouveau sécurisé :<br><br>' . $forgot_password_url . '<br><br><b>Le lien est valide 15 minutes.</b><br><br>Merci de ne pas répondre à ce message. Si besoin, utilisez le formulaire de contact présent sur la page d\'accueil du site.<br><br>Bien à vous. <br><br>' . $this->getParameter('website_title') . '</p>');
